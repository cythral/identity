...
namespace Brighid.Identity.Auth
{
    public interface IAuthUtils
    {
        ...
        /// <param name="issuer">The issuer to use for the certificate.</param>
        /// <returns>The resulting access token.</returns>
        string GenerateAccessToken(AuthenticationTicket authenticationTicket, string issuer);
        ...
        string GenerateIdToken(AuthenticationTicket authenticationTicket, User user, string issuer);
    }
}
